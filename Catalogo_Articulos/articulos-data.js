var ETCM_ARTICLES = [
  {
    "id": "2",
    "titulo": "Informational Indoor Orientation in University Environments Using a RAG Agent over Structured Knowledge",
    "autores": "Anddy Camacho-Romero; Oscar M. Cumbicus-Pineda; Luis Chamba-Eras",
    ...
    "resumenCorto": "This paper presents a Retrieval-Augmented Generation (RAG)-based agent for indoor localization of academic spaces in a university environment. The…",
  ...
  {
    "id": "3",
    "titulo": "LoRA-Based Adaptation of LLaMA 2 for Robust Emotion Detection in Spanish: A Multi-Corpus Approach",
    "autores": "Joseph Ríos-Salas; Oscar M. Cumbicus-Pineda; Luis Chamba-Eras",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Emotion detection in Spanish text remains a challenging task due to the scarcity of high-quality annotated resources and the linguistic variability of the…",
  ...
  {
    "id": "4",
    "titulo": "Evaluating Zero-Shot Multimodal LLMs and Supervised CNN Classifiers for Glove Detection in PPE Use Compliance",
    "autores": "Jorge Parraga-Alava; Jorge Rodas-Silva",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Non-compliance with Personal Protective Equipment (PPE) regulations, particularly safety glove wearing, remains a critical occupational safety challenge…",
  ...
  {
    "id": "5",
    "titulo": "Real-Time Deepfake and Face Spoofing Detection Using Deep Learning",
    "autores": "Rohith K; P Sunil Chowdary; R Yugha",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Deep learning technology has advanced an ever-increasing rate and the use of biometric authentication and digital media verification systems are at a…",
  ...
  {
    "id": "22",
    "titulo": "Enhancing operational efficiency of spraying drones: a swarm intelligence approach via ABC algorithm and SfM reconstruction",
    "autores": "Fabricio Rolando Marcillo Vera; Jericko Gandy Tenorio Cordero; Víctor Adriel Aveiga Chuez; Sebastian Andrés Guzmán Torres; David Sebastián Vargas Muñoz; Marcos Francisco Morales Sanchez",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Precision agriculture (PA) has become increasingly important due to its benefits for the environment as well as for producers’ efficiency and profit…",
  ...
  {
    "id": "58",
    "titulo": "Modeling of Thermal Comfort Using Artificial Neural Networks for HVAC System Control",
    "autores": "Juan José Laínez Bolaños; Douglas Antonio Plaza Guingla; Carolina Alexandra Casal Quintero; Juan José Laínez Casal",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "This study evaluated thermal comfort using an adaptive correlational approach in air-conditioned buildings at the University of Guayaquil. Data from 650…",
  ...
  {
    "id": "78",
    "titulo": "A Hybrid Dual-Branch Pipeline for Automated Network Threat Triage in Security Operations Centers",
    "autores": "Alexander Rafael González García; Manuel Eugenio Morocho-Cayamcela",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Alert fatigue is a critical bottleneck in security operations centers. Analysts dismiss 62% of daily alerts without review due to volume overload…",
  ...
  {
    "id": "94",
    "titulo": "GRU-ANFIS: A Neuro-Fuzzy Adaptive Controller for Wind Turbine Pitch Optimization Learned from SCADA Data",
    "autores": "Lia-Nicole Pesantez-González; Francis-Nicole Benitez-Montalvo; Nathalia-Michelle Peralta-Vasconez; Pablo-Andrés Buestán-Andrade",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Wind turbine blade pitch control under stochastic aerodynamic conditions remains a critical challenge for maxi- mizing energy yield while limiting…",
  ...
  {
    "id": "127",
    "titulo": "Automatic Identification of Guayusa and Urtica Leaves Using Explainable Convolutional Neural Networks",
    "autores": "Lorena Guachi-Guachi; Juan Soto; Jhoel Zumba",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Medicinal plants play an important role in traditional healthcare systems and biodiversity conservation in Latin America. However, automatic recognition…",
  ...
  {
    "id": "128",
    "titulo": "Analysis of Interlinguistic Bias in Generative Artificial Intelligence Models",
    "autores": "Gema Bravo-Navarrete; Lucía Rivadeneira",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Abstract— As generative artificial intelligence tools based on large language models continue to expand across multilingual contexts, limited research has…",
  ...
  {
    "id": "137",
    "titulo": "Uncertainty-Aware Academic Performance Analysis Using Natural Gradient Boosting and Socioeconomic Attributes",
    "autores": "Jorge Iván Pincay-Ponce; José Jacinto Reyes-Cárdenas; Anthony Cristopher Legarda-Albiño; Gary Reyes; Maira Moncerrate Menéndez-Otacoma; Gabriela Maholy Velásquez-Moreira",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Academic performance is a multifactorial phenomenon where predictive uncertainty quantification is as critical as classification accuracy. Under the…",
  ...
  {
    "id": "149",
    "titulo": "Deep learning-based temporal classification of ecchymosis using colorimetric feature fusion and transfer learning",
    "autores": "Brayan Duran; Dalet Carrillo; Marlon Soza; Viviana Moya; Alvaro Prado",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Accurate temporal estimation of cutaneous ecchymosis remains a challenging problem in forensic image analysis due to the subjectivity and limited…",
  ...
  {
    "id": "153",
    "titulo": "Semantic Prompt Analysis for YOLOE Open-Vocabulary Kiwifruit Detection in Agricultural Environments",
    "autores": "Piero Giomar Vilcapoma; Ingrid Nicole Vásconez; Miryam Valenzuela; Guillermo Toro; Juan Pablo Vásconez",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Open-vocabulary detection models have recently become a promising alternative for agricultural perception, since they can localize unseen objects through…",
  ...
  {
    "id": "166",
    "titulo": "Multi-Architecture Benchmark of Anomaly Detection Models for Vehicular Hijacking from GPS Trajectories",
    "autores": "Edison Solorzano; Jorge Parraga-Alava; Enrique Dominguez",
    "track": "Computational Intelligence",
    "keywords": [
      "Vehicular Hijacking",
      "GPS Trajectories",
    ...
    "resumenCorto": "Vehicular hijacking and cargo theft pose critical security threats to freight logistics networks. Real-time detection requires analyzing GPS trajectories…",
  ...
  {
    "id": "175",
    "titulo": "Explainable Machine Learning for SME Success Prediction in Public Procurement: A SHAP-Based Analysis Using European Tender Data",
    "autores": "Maria Fernanda Molina Miranda",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Small and medium-sized enterprises (SMEs) face persistent structural barriers to participation in public procurement processes, limiting their access to…",
  ...
  {
    "id": "186",
    "titulo": "Reinforcement Learning-Based Navigation in a Discret Grid Environments: A Comparative Study of Q-Learning, DQN, and Discret SAC",
    "autores": "Alejandra Pinzon Farfan; Pamela P. Alvarez; Juan M. Calderón; Marco E. Benalcázar; Juan Pablo Vásconez",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Autonomous navigation in search-and-rescue scenarios requires agents that can adapt to uncertain environments and irregular obstacle configurations. This…",
  ...
  {
    "id": "187",
    "titulo": "Demand Forecasting and Analysis in the Hardware Retail Sector Utilizing Machine Learning Models",
    "autores": "Oliver Correa-Ramírez; Anthony Rodríguez-Zambrano; Tania Rojas; David Cárdenas-Villacres",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "The systematic optimization of inventory frame works within the hardware retail sector constitutes a critical operational challenge, primarily concerning…",
  ...
  {
    "id": "194",
    "titulo": "Multi-Fruit Tracking and Counting in Tree Tomato Orchards Using Deep Learning and Kalman Filtering",
    "autores": "Ingrid Nicole Vásconez; Pablo Vargas; Andrea Pilco; Luis A. Córdova-Tandazo; Leonardo Guevara; Juan Pablo Vasconez",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "This study presents an automated framework for tree tomato detection, tracking, and counting in orchard environments. The proposed approach combines a…",
  ...
  {
    "id": "199",
    "titulo": "A CRISP-DM-Based Pipeline for Predicting Early University Dropouts: A Real-World Case Study",
    "autores": "Dayron Rumbaut Rangel; Carlos Enrique George-Reyes; Gary Reyes; Franklin Parrales-Bravo; Peggy Ricaurte-Ulloa; Roberto Tolozano-Benites",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Student dropout rates in online higher education affect the quality, completion rates, and sustainability of selffinanced institutions. This paper…",
  ...
  {
    "id": "209",
    "titulo": "Drone Inspection of the Agoy\\'an Hydroelectric Dam using Faster R-CNN and ResNet50",
    "autores": "Juan Pablo Vasconez; Pablo Vargas; Oswaldo Menéndez; Lorena Isabel Barona López; Ángel Leonardo Valdivieso Caraguay; Marco E. Benalcázar",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Visual inspection of hydroelectric dams is challenging due to hazardous operating conditions, restricted accessibility, and dynamic environmental factors…",
  ...
  {
    "id": "214",
    "titulo": "Comparison and Evaluation of Sparse Autoencoders (SAE) in Board Games",
    "autores": "Jonathan Zea; Gilson Chango; Karina Arichavala; Lorena Barona; Angel Valdivieso; Marco Benalcazar",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Sparse Autoencoders (SAEs) are unsupervised learning methods that decompose neural network activations into sparse latent representations, enabling the…",
  ...
  {
    "id": "221",
    "titulo": "Optimization of Legal Assistance in Ecuador through RAG Architectures: Evaluation Against General-Purpose LLMs",
    "autores": "Marco Castelo; Andrés Ojeda; René Omar Villa; Marcos Alejandro Dávalos",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "This article presents a legal assistant based on Retrieval-Augmented Generation (RAG) designed for Ecuadorian law. The system combines a specialized legal…",
  ...
  {
    "id": "222",
    "titulo": "Monthly Demand Forecasting in the Cosmetics Sector Using Ensemble Machine Learning: A Comparative Study of Random Forest, XGBoost, and LightGBM",
    "autores": "Juan-Sebastian Patiño-Cuesta; Paula-Renata Tenesaca-Pineda; Brian-Andersson Rivera-Emperador; Nathalia-Michelle Peralta-Vasconez",
    "track": "Computational Intelligence",
    "keywords": [
      "Cosmetics Sector",
    ...
    "resumenCorto": "Monthly demand forecasting in the cosmetics sector represents a critical operational challenge due to high variability across product categories. This…",
  ...
  {
    "id": "278",
    "titulo": "Multitemporal Environmental Monitoring of Aggregate Quarry Expansion in Santa Cruz, Galápagos Using Spectral Computer Vision Techniques",
    "autores": "Paul Rodríguez; Kevin Erazo; Paulina Vizcaíno-Imacaña; Iván Reyes-Chacón; Manuel Eugenio Morocho Cayamcela",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "The Galápagos Islands face a unique environmental challenge due to restrictions on importing construction materials from mainland Ecuador, forcing the…",
  ...
  {
    "id": "304",
    "titulo": "Face-PID: Physics-Informed Latent Diffusion for Visible-to-Thermal Face Translation",
    "autores": "Patricio Xavier Moreno-Vallejo; Gisel Katerine Bastidas-Guacho; Angel D. Sappa",
    "track": "Computational Intelligence",
    "keywords": [
    ...
    "resumenCorto": "Visible-to-thermal face translation is a challenging cross-spectral image synthesis task due to the large appearance gap between visible and long-wave…",
  ...
  {
    "id": "6",
    "titulo": "Hybrid Electro-Thermal Modeling of Induction Machines Using ATP-EMTP",
    "autores": "Anderson Maldonado; Bill Maldonado; Jose Aller",
    ...
    "resumenCorto": "This work presents the development of a hybrid electro-thermal model of a three-phase induction machine implemented in ATP-EMTP and ATPDraw. The model…",
  ...
  {
    "id": "8",
    "titulo": "Benchmarking Machine Learning Models for Anomalous Electricity Consumption Detection",
    "autores": "Julio Pérez; Luis Morales; José Llagua; Patricio Pesántez; Carlos Gallardo; Marcelo Pozo",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Non-technical losses (NTLs) represent a major challenge for electricity distribution companies, reducing revenue and distorting the interpretation of…",
  ...
  {
    "id": "12",
    "titulo": "Securing Ecuador’s Grid: BESS for Generation Adequacy After the 2024 Crisis",
    "autores": "Manuel S. Alvarez-Alvarado; Fabricio Porras-Ortiz; David S. Mendieta-Rodas",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Ecuador’s National Interconnected System (NIS) is highly dependent on hydropower, making it vulnerable to extreme droughts and climate variability. In…",
  ...
  {
    "id": "28",
    "titulo": "From Simulation to Prototype: Development of a Non-Conventional Hydrokinetic Energy System",
    "autores": "Carlos Cuenca; Jonathan Quistial-Balseca; Angel Ochoa-Villamar; Milton Cuenca; Luis Gonzaga-Bermeo",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Traditional design approaches in hydrokinetic systems often rely on extensive experimental iteration or remain limited to purely computational studies…",
  ...
  {
    "id": "36",
    "titulo": "Structuring and Analysis of Experimental Data on the Corona Effect for Diagnosis and Monitoring of High-Voltage Electrical Systems",
    "autores": "Flavio Quizhpi; Bryan Jara; Mateo Quizhpi Cuesta",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "This article presents a methodology for processing and organizing data obtained from corona discharge tests carried out in the High Voltage Laboratory of…",
  ...
  {
    "id": "42",
    "titulo": "Dual-Regulated Wireless Charging Framework for EVs Based on Hybrid Compensation Networks",
    "autores": "Noor Sami; Harith Al-Badrani; Marcelo Pozo",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Many applications in biomedical devices, consumer electronics, Electric Vehicles depend on the wireless power transfer such that this technology has a…",
  ...
  {
    "id": "107",
    "titulo": "Three-State Stochastic Petri-Net Modeling of HL1 Generation Adequacy Under Derated Operation",
    "autores": "Daniel Andrés Cevallos Valdiviezo; Holger Ignacio Cevallos Ulloa; Manuel S. Alvarez-Alvarado; Leandro Jeanpierre Chicaiza Zambrano; Eduardo Javier Rodriguez Nieto",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Power-system adequacy studies at Hierarchical Level I (HL1) are commonly performed using binary generation-unit models, where each unit is represented as…",
  ...
  {
    "id": "115",
    "titulo": "Optimal Design of a PV-BESS System: Mixed-Integer Linear Programming Approach for Project Efficiency and Feasibility",
    "autores": "Roberto Quintana Escurra; Yoryi Walter Mercado Cerron",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "This article emphasizes the importance of BESS in contexts with unstable power supplies. To achieve optimal sizing, a methodology consisting of four (4)…",
  ...
  {
    "id": "119",
    "titulo": "Comparative Assessment of ELCC, ECP, and Firm Capacity Methodologies for Resource Adequacy in Renewable-Dominated Power Systems",
    "autores": "Diego Arias-Cazco; Manuel S. Alvarez-Alvarado; Deivid Gaona-Ramos; Pablo Arias-Cazco",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "The growing penetration of variable renewable energy has exposed the limitations of peak-based generation adequacy metrics. This paper presents a unified…",
  ...
  {
    "id": "157",
    "titulo": "Techno-Economic Feasibility of Floating Photovoltaics for Rural Electrification in Coastal Ecuador",
    "autores": "Diego Peña; Banner Palacios; Samantha Puente; Jorge Murillo",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Rural electrification in tropical regions remains a structural challenge, particularly for communities surrounded by agricultural land and small water…",
  ...
  {
    "id": "158",
    "titulo": "State estimation using the Kalman filter in electrical networks Distribution",
    "autores": "Edwin Patricio Aguilar Lema; Carlos Ivan Quinatoa Caiza; William La Cruz",
    "track": "Power and Energy",
    "keywords": [
      "Kalman filter",
    ...
    "resumenCorto": "The transition to active and unbalanced distribution networks demands advanced monitoring schemes, as static voltage-based estimators are limited by…",
  ...
  {
    "id": "160",
    "titulo": "Photovoltaic Output Power Prediction Using Data Science: A Comparative Study of Machine Learning and Deep Learning for a Campus-Scale System in Ecuador",
    "autores": "Angel Ivan Torres Quijije; Nayla Raquel Vargas Pilay; Eduardo Amable Samaniego Mena; Jimmy Aldrin Cedeno Barzola",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Accurate short-term forecasting of photovoltaic (PV) output power is essential for effective renewable energy management. This paper presents a…",
  ...
  {
    "id": "167",
    "titulo": "Second Life Process using EV Battery Model for Confort Thermal",
    "autores": "Efren Fernandez; Gustavo Alvarez; Julio Cuisano",
    "track": "Power and Energy",
    "keywords": [
      "Second Life Process",
      "EV Battery Model",
    ...
    "resumenCorto": "This article describes the development and implementation of a thermal comfort system using second-life ion-lithium electric vehicle batteries. The…",
  ...
  {
    "id": "182",
    "titulo": "Multi-Period Transmission Expansion Planning under Renewable Uncertainty: A Scenario-Based Framework for Optimal Line Commissioning",
    "autores": "Carlos Barrera-Singaña; María Paz Comech; Hugo Arcos",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "This paper proposes a multi-period scenario-based transmission expansion planning framework under renewable uncertainty. The model considers a 15-year…",
  ...
  {
    "id": "236",
    "titulo": "Grid Scale BESS in the Energy Transition: Architecture, Grid Services, and Cyber Resilience",
    "autores": "Ruben Hidalgo-Leon; Alejandra Risco-Bravo; Pritpal Singh; Stephanie Solano-Villao; Miguel Torres; Guillermo Soriano; Jorge Vega; Julio Barzola-Monteses",
    "track": "Power and Energy",
    "keywords": [
      "Grid Scale BESS",
    ...
    "resumenCorto": "The increasing penetration of variable renewable generation is reshaping the operational requirements of modern power systems, particularly in terms of…",
  ...
  {
    "id": "238",
    "titulo": "Repurposing EV Batteries for Second-Life Applications: Degradation and Economic Feasibility",
    "autores": "Ruben Hidalgo-Leon; Alejandra Risco-Bravo; Pritpal Singh; Diego Campoverde-Munoz; Athar Nafis Md Wasi; Guillermo Soriano; Frank Porras; Miguel Torres",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "The increasing adoption of electric vehicles is expected to generate a growing volume of retired lithium-ion batteries in the coming years. Although these…",
  ...
  {
    "id": "241",
    "titulo": "Transient Stability Assessment of IBR-Dominated Power Systems: A Study on Hybrid Grid-Forming and Grid-Following Configurations",
    "autores": "Diego Ortiz-Villalba; Álvaro Tenorio-Apaza; Miguel Challapa-Mamani; Jorge Vega-Herrera; Alex Villamarín-Jácome; Ruben Hidalgo-León",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "This paper evaluates the transient stability of the two-area Kundur system with a high penetration of inverter based resources (IBRs) using…",
  ...
  {
    "id": "246",
    "titulo": "Comparative Analysis of Backward–Forward Sweep and BIBC–BCBV Methods for Unbalanced Radial Distribution Systems",
    "autores": "Javier Markley",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "This study presents the development and validation of a Python-based algorithm for unbalanced three-phase power flow analysis in a 13.8 kV medium-voltage…",
  ...
  {
    "id": "253",
    "titulo": "Low-Frequency Stability Analysis of Railway Systems Using Simplified Small-Signal Models",
    "autores": "Paul Frutos",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Power electronic converters in modern electric rail vehicles have been reported to be a source of low-frequency oscillations (LFO), which can eventually…",
  ...
  {
    "id": "256",
    "titulo": "Optimal Expansion Planning of Photovoltaic Distributed Generation in Power Distribution Networks Considering Unbalanced Power Flows within a Power Supplied Interruption Context",
    "autores": "Diego Ortiz; Daniel Cabezas-Monteros; Luis Millingalle-Simba; Jimenez-De La Vega William; Llanos Jacqueline; Alex Villamarin-Jacome",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Real distribution networks commonly operate under unbalanced conditions due to asymmetric single-phase loads and non-uniform configurations, yet…",
  ...
  {
    "id": "257",
    "titulo": "Field Monitoring and Retrofit Assessment of CO2-Based Ventilation Performance in Tropical University Classrooms",
    "autores": "Walter Gamarra-Yepez; Jaqueline Litardo; Frank Porras; Guillermo Soriano",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Maintaining adequate indoor air quality in educational buildings is particularly challenging in hot-humid climates, where the introduction of outdoor air…",
  ...
  {
    "id": "281",
    "titulo": "Grid-Based Spatial Load Forecasting via Agglomerative Hierarchical Clustering: Case Study of an Electrical Distribution Utility",
    "autores": "Eduardo Morales-Jadan; Sergio Zambrano-Asanza; Ivón Benítez González; Carlos Santos-Pérez; Reinier Herrera-Casanova",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Monthly metering data remains the primary source of demand information for many distribution utilities, limiting the use of high-resolution forecasting…",
  ...
  {
    "id": "299",
    "titulo": "River-Friendly Hydrokinetic Energy Assessment: Power Potential Evaluation in the Tomebamba River, Cuenca, Ecuador",
    "autores": "Adrian Criollo; Ismael Minchala; Danny Ochoa; María Emilia Sisalima Jara; Diego Javier Tenesaca Malla; José Fernando Reino Criollo",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "This study evaluates the technical feasibility and energy potential of installing a Smart Free Stream hydrokinetic turbine in the Tomebamba River through…",
  ...
  {
    "id": "307",
    "titulo": "Impact of Source-Constrained Pumping on Pumped-Storage and Cascaded Hydropower Dispatch in Hydro-Dominated Power Systems",
    "autores": "Iván León; Alex Villamarín; Willian Jiménez; Ariel Chancusig; Diego Ortiz; Jorge Vega",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "Increasing hydrological variability in hydro-dominated power systems intensifies the operational value of pumped-storage hydropower (PHS) while making…",
  ...
  {
    "id": "311",
    "titulo": "Impact of Transmission and Distribution-Level BESS on the Operation of Hydro-Dominated Power Systems with Low Integration of Variable Renewables",
    "autores": "Nayeli Panchi; Alex Villamarín; Willian Jiménez; Diego Ortiz",
    "track": "Power and Energy",
    "keywords": [
    ...
    "resumenCorto": "This paper evaluates the impact of battery energy storage systems (BESS) deployed at transmission and distribution levels on the unit commitment and…",
  ...
  {
    "id": "122",
    "titulo": "Experimental Analysis of RSSI and SNR performance in an AU915 LoRaWAN Smart Apiary Deploymen",
    "autores": "Edzel Alejandro Escobar Cueto; Patricia Nataly Flores Ponce; Eynar Calle Viles; Edgar Roberto Ramos Silvestre",
    ...
    "resumenCorto": "This paper presents a technical evaluation of a LoRaWAN network configured in the AU915 band for remote apiary monitoring. Unlike a general Internet of…",
  ...
  {
    "id": "271",
    "titulo": "Comparative Analysis of NYUSIM-Based mmWave and Sub-THz Channels",
    "autores": "René Játiva E.; José Castillo; Adrián Ávila; Marcelo Sigüenza",
    "track": "Antennas and Propagation",
    "keywords": [
    ...
    "resumenCorto": "The transition from millimeter-wave (mmWave) to sub-terahertz (sub-THz) frequency bands is expected to play a key role in future 6G wireless systems…",
  ...
  {
    "id": "283",
    "titulo": "Comparative Analysis of Empirical Path Loss Models for 2.4 GHz Wi-Fi Propagation in Multi-Level Reinforced Concrete Residential Environments",
    "autores": "Aaron David Cuadrado Garces; Douglas Alexander Agualsaca Guallo",
    "track": "Antennas and Propagation",
    "keywords": [
    ...
    "resumenCorto": "This paper evaluates three empirical models (Keenan-Motley, ITU-R P.1238, and COST 231 Multi-Wall) for predicting 2.4 GHz Wi-Fi propagation in a…",
  ...
  {
    "id": "287",
    "titulo": "AI-Based Reconstruction of Antenna Radiation Patterns From Sparse SDR Measurements",
    "autores": "Danilo Gabriel Cevallos; Carlos Leónidas Yépez; Fernando Lara; Aldrin Reyes Narváez; Hernan Barba Molina",
    "track": "Antennas and Propagation",
    "keywords": [
    ...
    "resumenCorto": "This article presents an SDR-based AI framework for reconstructing the azimuthal radiation pattern of an antenna under test from a reduced set of real…",
  ...
  {
    "id": "1",
    "titulo": "eΦCiencia Laboratory: A Case Study of Low-Cost 3D-Printed Physics Instrumentation in Engineering Education",
    "autores": "Luis Pabon-Orozco; Gabriel Barreto-Nunez; Carlos Cuenca-Cabrera; Gabriela Parrales-Jimenez; Angel Ochoa-Villamar; Erick Lamilla Rubio",
    ...
    "resumenCorto": "Active learning methodologies have become essential in modern pre-university and university classrooms; however, with the rapid emergence of artificial…",
  ...
  {
    "id": "15",
    "titulo": "Controlled Integration of Shared LLM Chatbots in Competency-Based Electrical Engineering Program: A Study of Student Adoption and Perceptions Across Curricular Levels",
    "autores": "Danny Espín; Leonardo Vivas; Johnny Rengifo",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "This study examined the controlled integration of LLM-based chatbots trained to reflect the specific characteristics of each course in a competency-based…",
  ...
  {
    "id": "19",
    "titulo": "Assessing the Industry Readiness of Graduating Gen Z Engineering Student: Identifying Key Influencing Factors",
    "autores": "Renz Angelo Eugenio; Johanne Raymond Gaspar; Martin Luis Vibar; John Kenneth Sison; George Domantay; Channen Kyle Cruz; Maricar Navarro",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "The transition from academic learning to industry practice remains a persistent challenge for graduating engineering students as Higher Education…",
  ...
  {
    "id": "52",
    "titulo": "AgenteTutor-UBE: A Modality-Aware Multi-Agent Tutoring System Grounded in Psychopedagogical Principles and the 4D AI Fluency Framework for Graduate Thesis Supervision",
    "autores": "Roger Martínez Isaac; Sonia Guerra Iglesias; Odette Martínez Pérez; Luis Enrique Silva Adriano; Manuel Fabricio Reyes Wagnio; Maikel Leyva-Vázquez Leyva-Vázquez",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "The widespread availability of LLMs in higher education has created a critical gap: AI tools are accessible but pedagogically unstructured, frequently…",
  ...
  {
    "id": "53",
    "titulo": "Impact of a Service-Learning-Based Electrical Community Project on Engineering Competencies and Community Perception",
    "autores": "Doménica Apolo; Jocelyne S. Salgado; Hector Plaza; Otto Alvarado",
    "track": "Education in Engineering",
    "keywords": [
      "Community",
      "Competencies",
    ...
    "resumenCorto": "The development of professional competencies in engineering education requires the integration of theoretical knowledge with practical experience in…",
  ...
  {
    "id": "64",
    "titulo": "Temporal Lexical Shifts in First-Time Virtual Reality Experiences: An Exploratory Study with Rural Girls in Ecuador",
    "autores": "Lorena Guachi-Guachi; Mónica Vaca; Lizbeth Cruz; Robinson Guachi; Juan Gonzalez",
    "track": "Education in Engineering",
    "keywords": [
      "Rural Girls",
    ...
    "resumenCorto": "Virtual Reality (VR) and Human-Computer Interaction (HCI) technologies are increasingly used to support STEM education through immersive learning…",
  ...
  {
    "id": "86",
    "titulo": "Design of a low-cost open-source micro-scale Smart Car platform for Engineering Education in Autonomous Systems",
    "autores": "Angel Recalde; Ricardo Alfredo Cajo Diaz; Jose Vaca; David Narvaez; Francisco Yumbla",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "Li-ion battery-powered autonomous vehicles require the integration of embedded control, sensing, communication, energy measurement, and decision-making…",
  ...
  {
    "id": "97",
    "titulo": "Preliminary Design and Functional Verification of a Mixed Reality Training Prototype for Guided PC Assembly Using Meta Quest 3",
    "autores": "Listher Gabriel Vera Vera; Juan-Andres Garate-Peralta; Tatiana-Alexandra Cabrera-Silva; Pablo-Andrés Buestán-Andrade",
    "track": "Education in Engineering",
    "keywords": [
      "Meta Quest 3",
      "Guided PC Assembly",
    ...
    "resumenCorto": "Technical training in computer assembly requires learners to understand component identity, placement, orienta- tion, and procedural order before…",
  ...
  {
    "id": "110",
    "titulo": "Design and Preliminary Evaluation of a Multiplatform Virtual Tour for Interactive Exploration of University Laboratories",
    "autores": "Matias Alexander Cabrera Navas; Jonh Luis Estrada Guayta; Listher Gabriel Vera Vera; Tatiana Alexandra Cabrera Silva",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "Universities require interactive digital resources to communicate academic infrastructure beyond static websites or conventional institutional…",
  ...
  {
    "id": "133",
    "titulo": "Acceptance of an Entrepreneurship Platform in the Latin American University Environment: A Study on Implementation and User Experience",
    "autores": "Carlos Enrique George-Reyes; Ennio Jesús Mérida-Córdova; Gary Reyes; Miriam Cerón-Peralta",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "This work evaluated a digital platform designed to develop complex thinking in scientific entrepreneurship. The OpenEDR4C platform was implemented in five…",
  ...
  {
    "id": "138",
    "titulo": "Student Discourse in Moodle Forums: Qualitative Learning Analytics through LEXINET",
    "autores": "Ennio Jesús Mérida-Córdova; Hendy Maier Pérez-Barrera; Raul López-Fernández; Carlos Enrique George-Reyes",
    "track": "Education in Engineering",
    "keywords": [
      "Moodle Forums",
      "Student Discourse",
    ...
    "resumenCorto": "This innovation paper presents a qualitative learning analytics experience centered on student discourse in Moodle forums. The study analyzed the implicit…",
  ...
  {
    "id": "139",
    "titulo": "Characterizing Student Engagement through Learning Analytics and Automated Discourse Analysis in Moodle Forums",
    "autores": "Hendy Maier Pérez-Barrera; Ennio Jesús Mérida-Córdova; Raul López-Fernández; Carlos Enrique George-Reyes",
    "track": "Education in Engineering",
    "keywords": [
      "Moodle Forums",
    ...
    "resumenCorto": "This study presents an analytical workflow that combines learning analytics and natural language processing to characterize communicative patterns in…",
  ...
  {
    "id": "150",
    "titulo": "AI-Powered Gamification in Higher Education Institutions:A Systematic Literature Review",
    "autores": "Gunther Oberdam Baque Vera; Diego Sornoza Parrales; Tania Maricela Macias Parrales; Heinz Jürgen Baque Baque; Miguel Eduardo Baque Arteaga; José René Castillo Villamar",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "The convergence of gamification and artificial intelligence (AI) is reshaping teaching and learning practices in higher education institutions (HEIs), yet…",
  ...
  {
    "id": "173",
    "titulo": "Immersive Technologies for Computational Thinking in Engineering Education: Evidence from a Private Mexican University",
    "autores": "Carlos Enrique George-Reyes; Miriam Cerón-Peralta",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "Engineering education requires learning experiences that enable students to translate complex problems into structured procedures. This paper analyzes an…",
  ...
  {
    "id": "190",
    "titulo": "Conceptual Model for the Implementation of Intelligent Assistants in Higher Education Institutions",
    "autores": "Cristina Pesantez",
    "track": "Education in Engineering",
    "keywords": [
      "Higher Education Institutions",
      "Assistants",
    ...
    "resumenCorto": "Higher education institutions increasingly face challenges related to the provision of academic and administrative services due to growing student…",
  ...
  {
    "id": "201",
    "titulo": "Experimental Identification and Model Predictive Control of an Educational Temperature Platform for Control Education",
    "autores": "Luis Caiza; Diego S. Benitez; Oscar Camacho",
    "track": "Education in Engineering",
    "keywords": [
      "Control Education",
      "MPC",
    ...
    "resumenCorto": "This paper presents the identification and control of the temperature process of an Educational Control Plant (EPC) using PID and Model Predictive Control…",
  ...
  {
    "id": "228",
    "titulo": "Integrating Mathematical Modeling, Numerical Simulation, and Experimental Validation Through a Monoatomic Mass-Spring Chain in Engineering Education",
    "autores": "José Manuel Nieto Jalil; Juan M. Martínez Huerta; Adrián Isrrael Tec Chim; Iván Gutiérrez-Cruz",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "Mathematical modeling is a fundamental component of engineering education because it enables students to represent, analyze, and predict the behavior of…",
  ...
  {
    "id": "232",
    "titulo": "An Explainable Neutrosophic-Adaptive Web Architecture for Mathematical Competency Training with Empirically Seeded Monte Carlo Validation",
    "autores": "Elsy Rodríguez Revelo; Lorenzo Cevallos Torres; Vicente Villegas Ricauter",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "Incoming engineering students often exhibit heterogeneous mathematical preparation. This paper presents an explainable neutrosophic-adaptive extension for…",
  ...
  {
    "id": "240",
    "titulo": "Promoting Gender Equity Through STEM Academies: A Systematic Literature Review",
    "autores": "Karla Daniela Perez-Robles; Leticia Vaca-Cardenas",
    "track": "Education in Engineering",
    "keywords": [
      "STEM Academies",
    ...
    "resumenCorto": "The gender gap in STEM fields persists, driven by sociocultural factors, underscoring the need for effective educational strategies. This study analyzes…",
  ...
  {
    "id": "243",
    "titulo": "From Transistors to Systems: A Proposal for an Undergraduate Digital Systems Course from HDL to Silicon",
    "autores": "Byron Tarabata",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "This article presents a proposed curriculum redesign for a Digital Systems course in electrical and electronic engineer- ing programs, aiming to overcome…",
  ...
  {
    "id": "254",
    "titulo": "An Evidence-to-Action Framework for Continuous Improvement of Student Outcomes in an Electronics and Automation Engineering Program",
    "autores": "Daniel Andrés Cevallos Valdiviezo; Sofía Anabel López Iglesias; Jorge Williams Aragundi Rodriguez; Rafael Ignacio Bonilla Armijos; Sara Judith Ríos Orellana; Gabriela Paola Salcán Reyes; Roxana Marianela Rodríguez Silvestre",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "Continuous improvement in engineering education requires more than reporting that a student-outcome average exceeds a threshold; it requires a traceable…",
  ...
  {
    "id": "258",
    "titulo": "Adaptive Gamification Strategies for Improving Academic Performance in First-Year Engineering Students",
    "autores": "Diego Escobar-Bermudes; Mauricio Carvache-Franco; Aleksandra Minchenkova; Orly Carvache-Franco; Wilmer Carvache-Franco; Martin Escobar Nuñez",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "First-year engineering students frequently experience difficulties related to academic engagement, motivation, and performance, particularly in courses…",
  ...
  {
    "id": "274",
    "titulo": "Perception and Use of ChatGPT in Peruvian Teaching",
    "autores": "Ronald Melgarejo-Solis; Denis Aguilar-Ortega; Luis Mario Saldaña Sánchez; Rony Smith Grijalva De la Cruz; Emilio Denis Enrique Cabello Villon; Juan Adrian Chipana Cueva; Jean Franco Aquino Rojas; Ramesh Chander Sharma",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "This paper analyzes Peruvian teachers' perceptions and use of ChatGPT as a support tool for teaching practice, pedagogical innovation, and professional…",
  ...
  {
    "id": "282",
    "titulo": "Student-Centered Learning Approach for a Postgraduate Industrial Control",
    "autores": "Camilo Andrés Sanabria Totaitive; Oscar Ivan Higuera-Martinez; Herman Fernández",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "This paper focuses on transforming the process control course of the graduate program in Industrial Automation at UPTC from a traditional curriculum to a…",
  ...
  {
    "id": "296",
    "titulo": "Curriculum Evaluation in Undergraduate Electrical Engineering Programs: A Central American Overview",
    "autores": "Carlos Mario Flores Lazo; Edwing Isaac Rosales Molina",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "This paper evaluates undergraduate electrical engineering curricula in Central America using selected ABET criteria as an international reference. Six…",
  ...
  {
    "id": "319",
    "titulo": "Using Game Mechanics to Enhance Engagement and Collaborative Competition in Technology Higher Education",
    "autores": "Diego Betancourt Anangonó; Gary Pulla Zambrano; Luis F. Ugarte",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "Gamification—the use of game design elements in non-game contexts—has become a widely adopted strategy for increasing motivation, engagement, and active…",
  ...
  {
    "id": "323",
    "titulo": "Design and Implementation of a 3kVA Resistive Experimental Load as a Learning Resource in Power Systems",
    "autores": "Luis Ugarte; Xavier Fierro; Noemi Moreno; Otto Alvarado",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "This paper presents the design and implementation of a 3 kVA experimental resistive load unit intended to strengthen practical learning in power systems…",
  ...
  {
    "id": "325",
    "titulo": "Educational Design of a 3D-Printed Skull Model for Migraine Surgery Training",
    "autores": "Leonel Vasquez-Cevallos; Erick R. Iles Velez; Ricardo Grunauer-Robalino; Erick Lamilla-Rubio; Darwin Castillo",
    "track": "Education in Engineering",
    "keywords": [
    ...
    "resumenCorto": "This paper describes the development and educational integration of a 3D-printed skull model as a physical aid for anatomy teaching in a migraine surgery…",
  ...
  {
    "id": "43",
    "titulo": "Neutro-Safe: A Neutrosophic Digital Twin for Structural Urban Violence Diagnosis in Guayaquil, Ecuador",
    "autores": "Maikel Leyva; Noel Batista; Lorenzo Jovanny Cevallos Torres; Alfonso Guijarro; Douglas Iturburu-Salvador; Florentin Smarandache",
    ...
    "resumenCorto": "Urban violence analysis in Latin American cities typically relies on scalar predictive indices that aggregate het erogeneous data sources, discarding the…",
  ...
  {
    "id": "121",
    "titulo": "Drift Aware Conformalized Tube Model Predictive Control for Smart City Campus Microgrid",
    "autores": "Eduardo Benavides",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "Smart city energy services increasingly rely on cyber physical energy systems and data driven automation to coordinate renewable generation, storage, and…",
  ...
  {
    "id": "145",
    "titulo": "A Hybrid Solar-Grid Charging Infrastructure Model for Sustainable Electric Bus Fleets in Quito, Ecuador",
    "autores": "Mónica Molina Barzola; Alexandra Yépez Vera; Josué Pincay Quiroz; Wellington Maliza Crúz",
    "track": "Smart Cities & Mobility",
    "keywords": [
      "Quito, Ecuador",
    ...
    "resumenCorto": "This paper presents a hybrid solar-grid charging infrastructure model designed to address the critical shortage of electric bus charging facilities in…",
  ...
  {
    "id": "146",
    "titulo": "Influence of air conditioning on the driving range of an electric delivery vehicle: Experimental evidence from a tropical urban environment",
    "autores": "José Mauricio Torres-Gómez; Gabriel Carrera-Rivera; Mayken Stalin Espinoza-Andaluz; Manuel Fernando Gómez-Barrezueta; Brayan Gabriel Ordoñez-Saca",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "The transition to electric mobility requires a precise understanding of energy consumption under real operating conditions and in specific environmental…",
  ...
  {
    "id": "154",
    "titulo": "Emulation and Performance Evaluation of an SDN-Based VANET Using ONOS, SUMO, and Mininet-WiFi",
    "autores": "Jaison Ilbay; Pierina Zambrano; Angel Puma; Johana Del Pozo",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "Intelligent vehicle networks based on Software-Defined Networking (SDN) offer an efficient solution for optimizing connectivity and dynamic traffic…",
  ...
  {
    "id": "224",
    "titulo": "Advances in BIM-IoT-Digital Twin Integration Toward Autonomous Smart Buildings",
    "autores": "Luis Antonio Andrade Matute; Juan Diego Belesaca; Fabian Astudillo-Salinas",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "Smart buildings are emerging as a key enabler of decarbonization, a process that entails the integration of Building Information Modeling (BIM), the…",
  ...
  {
    "id": "252",
    "titulo": "A Low-Latency Cloud-Native Architecture for Real-time Flood-Risk Intelligence: SAR--Oceanographic Fusion in the Guayas Estuary",
    "autores": "Guillermo Armando Veliz-Velez; Anibal Isaac Pruna Santillán; Marlon Estuardo Guadalupe Intriago; Jean Carlos Espinoza Vidal; Dennisse Marie Soledispa Avelino",
    "track": "Smart Cities & Mobility",
    "keywords": [
      "Guayas Estuary",
    ...
    "resumenCorto": "Real-time flood-risk intelligence in cloud-prone estuaries requires an architecture that remains responsive under heavy operator load and auditable in…",
  ...
  {
    "id": "280",
    "titulo": "Hybrid LSTM Model for Urban Congestion Prediction Using a Synthetic-Projected Dataset in Boyaca Street, Guayaquil, Ecuador",
    "autores": "Jefferson Cabrera-Amaiquema; Darwin Manzano-Cuenca; Renata Cervantes-Avilés; Evelyn López-Segura",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "Urban traffic congestion remains a critical challenge for mobility management in Latin American cities, particularly where open, structured, and locally…",
  ...
  {
    "id": "297",
    "titulo": "A Digital-Twin Hardware-in-the-Loop Testbed for Evaluating Traffic Signal Control Strategies",
    "autores": "Jose G. Quito; Galo Guzmán-Guillén; Pablo Barbecho Bautista",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "Field validation of urban traffic signal controllers (TSCs) is costly, difficult to reproduce, and potentially disruptive to normal traffic operations…",
  ...
  {
    "id": "309",
    "titulo": "Method to Analyze Efficiency in Electric Vehicles Case of Study Cuenca-Ecuador",
    "autores": "Efren Fernandez; Gustavo Alvarez; Nicolas Giraldo; Julio Cuisano",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "the increase in electric vehicles (EVs) in Ecuador has allowed the introduction of new technologies which seek to provide a series of economic…",
  ...
  {
    "id": "314",
    "titulo": "Domain Specific Multi-Objective Evolutionary Optimization for Intercantonal Electric Bus Deployment Planning",
    "autores": "Alcibar Yánez; Gabriel Luque; Mónica Mite; Estela Yánez Benavides; Julio Barzola",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "Electric-bus deployment has been widely studied in urban transport systems, where shorter routes, centralized de- pots, and terminal-based operations…",
  ...
  {
    "id": "321",
    "titulo": "Smart Charging and Renewable Integration in University Campuses: A View of Optimization Opportunities for Smart Cities",
    "autores": "Andrés García; Boris Cárdenas; David Arizaga; Johan Cepeda; Josué Cevallos; Rudy López; Michelle Tolozano; Luis Ugarte",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "The growing adoption of electric vehicles (EVs) creates new challenges for power systems, especially in locations with high charging demand. University…",
  ...
  {
    "id": "324",
    "titulo": "Evolutionary Operators and Feasibility Mechanisms for Electric Bus Charging Infrastructure Planning: A Systematic Review",
    "autores": "Alcibar Yánez; Gabriel Luque; Mónica Mite; Estela Yánez Benavides; Julio Barzola; Alejandra Orellana Maldonado; Luis Fernando Ugarte Vega",
    "track": "Smart Cities & Mobility",
    "keywords": [
    ...
    "resumenCorto": "Electric bus deployment requires integrated planning of charging infrastructure, route coverage, fleet assignment, charging schedules, battery autonomy…",
  ...
  {
    "id": "39",
    "titulo": "Anthocyanins from Vaccinium floribundum as Promising Natural Sensitizers for DSSCs: A Theoretical Study",
    "autores": "Danny Fuentes; José Gregorio Parra; Peter Iza",
    ...
    "resumenCorto": "Natural anthocyanins are promising eco-friendly sensitizers for dye-sensitized solar cells, although the electronic and photophysical properties of…",
  ...
  {
    "id": "226",
    "titulo": "New Approach to Design Low-Latency Asynchronous Controllers for Heterogeneous Systems",
    "autores": "Duarte Oliveira; Rosemberg Silva; Lourenço Junior",
    "track": "Circuits, Systems and Electron Devices",
    "keywords": [
    ...
    "resumenCorto": "Asynchronous controllers are very efficient at operating as high-performance interfaces in heterogeneous synchronous/asynchronous systems. The…",
  ...
  {
    "id": "227",
    "titulo": "An Implementation of QDI Asynchronous Logic Using Efficiently Factored Boolean Functions",
    "autores": "Duarte Oliveira; Rosemberg Silva; Lourenço Junior",
    "track": "Circuits, Systems and Electron Devices",
    "keywords": [
    ...
    "resumenCorto": "Quasi-delay-insensitive (QDI) circuits are a class of asynchronous circuits that provide simplified timing analysis and robustness against process, supply…",
  ...
  {
    "id": "100",
    "titulo": "Intelligent Wearable Band for Electromyographic and Kinematic Signal Acquisition Oriented to Motion Control",
    "autores": "Ney Coto; Henry Arauz; Andres Nenger; Jonathan Leon; Francisco Yumbla",
    ...
    "resumenCorto": "This work presents the development of a wearable intelligent band for the acquisition and classification of electromyographic (EMG) and inertial signals…",
  ...
  {
    "id": "101",
    "titulo": "Integration and Validation of Open-Source Fixed-Wing UAV Platforms for Low-Cost Autonomous Flight Research",
    "autores": "Steven Martinez; Joel Veloz; Jorge Hurel; Christian Tutivén; Francisco Yumbla",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "This study addresses the methodological and financial limitations imposed by closed-source commercial unmanned aerial vehicle (UAV) platforms on applied…",
  ...
  {
    "id": "105",
    "titulo": "Evaluating Synthetic, Hybrid, and Real Data Training Strategies for Vision-Guided Manipulation in a Planar 5R Parallel Robot",
    "autores": "Miguel Angel Silva Plata; Fabricio Javier Cabrera Gordillo; Nayara C. Lara Ramos; Gustavo Miranda; Yerko Garcia; Carlos Menacho Guerra",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "This work presents a vision-guided manipulation system implemented on a compact and low-cost planar 5R parallel robot. A procedural pipeline was developed…",
  ...
  {
    "id": "106",
    "titulo": "Recognition and Localization of Cubic Box Edges Using Computer Vision",
    "autores": "Kruger Ronquillo; Cristian Orozco; Juan Medrano; Marcelo Fajardo; Francisco Yumbla",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "This work presents a hybrid artificial vision system for detecting and estimating the consecutive position of box edges in automated logistics…",
  ...
  {
    "id": "125",
    "titulo": "Centralized Multi-Robot Control Based on Overhead Vision and Artificial Potential Fields",
    "autores": "Jhon Meneses; Jean Carlos Meneses; Holger Sanmartín; Tito Calva",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "This paper presents a centralized architecture for coordinating three differential-drive mobile robots in a shared workspace. An overhead camera connected…",
  ...
  {
    "id": "163",
    "titulo": "Efficient Collision-Free Trajectory Planning for Industrial Manipulators: A Comparative Study of PRM Variants and Graph Search Strategies",
    "autores": "Doménica Llanos; Juan Cruz; Tonny Toscano; Angel Sappa",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "Efficient collision-free trajectory planning is essential for industrial robotic manipulators operating in constrained environments with complex obstacle…",
  ...
  {
    "id": "178",
    "titulo": "Comparison of Local Language Models for Natural Language Command Analysis: Dobot Magician Case Study in ROS 2",
    "autores": "Anthony Eduardo Chamba Lara; Lía Nicole Pesántez González; Pedro Esteban Carrión Zamora; Pablo-Andrés Buestán-Andrade",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "The integration of large language models (LLMs) into robotic systems enables human instructions to be transformed into executable goals. However, their…",
  ...
  {
    "id": "185",
    "titulo": "UAV Altitude Estimation for Heterogeneous Mobile Robots Using YOLOv11 and Machine Learning Regression",
    "autores": "Jael Osorio; Andrea Pilco; William Chamorro; Viviana Moya; Juan Pablo Vasconez",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "Accurate altitude estimation of ground robots from aerial imagery is an important capability for heterogeneous multi-robot systems, enabling aerial…",
  ...
  {
    "id": "188",
    "titulo": "Comparative Experimental Evaluation of PID and Adaptive Fuzzy-PID Controllers for Multi-Joint Trajectory Tracking in a ROS 2 Collaborative Manipulator",
    "autores": "Francis-Nicole Benitez-Montalvo; Lía-Nicole Pesántez-González; Ángel-Isaías Gordillo-González; Nathalia-Michelle Peralta-Vasconez",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "This paper presents a comparative experimental evaluation between a classical PID controller and an adaptive Fuzzy-PID strategy for coordinated…",
  ...
  {
    "id": "197",
    "titulo": "SCARA-Based Robotic System for Neonatal Positive Pressure Ventilation Assistance in a Simulated Environment",
    "autores": "Kevin Daniel Gavilanes Gómez; Lizeth Pamela Casa Chacha; Juan Pablo Vásconez",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "Neonatal positive-pressure ventilation (PPV) is a critical procedure during neonatal resuscitation, where proper mask positioning directly influences…",
  ...
  {
    "id": "198",
    "titulo": "A Low-Latency Cyber-Physical Framework for Kinesthetic Programming by Demonstration Using Torque-OFF Self-Sensing",
    "autores": "Jholaus M. Villavicencio Lara; Tamia L. Gualán Saca; Juan P. Moreno Elizalde; José C. Reinoso López; John K. Macas Ortega; Juan Pablo Vasconez",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "Real-time synchronization is a key requirement for Cyber-Physical Systems (CPS), Digital Twins, and kinesthetic robot teaching. However, conventional…",
  ...
  {
    "id": "215",
    "titulo": "Impact of Simultaneous Localization and Calibration on Closed-Loop Cooperative Robot Radio Navigation",
    "autores": "Alexis Fernando Marino Salguero; Robert Pohlmann; Sofia Judith Sanchez Urresta; Emanuel Staudinger",
    "track": "Robotics and Automation Systems",
    "keywords": [
      "Localization",
      "Pose estimates",
    ...
    "resumenCorto": "Control of a team of mobile robots requires accurate pose estimates, which is particularly challenging when globally referenced external localization…",
  ...
  {
    "id": "251",
    "titulo": "Neural Network-Assisted PID Control for Formation Tracking of Differential Mobile Robots: Experimental Validation",
    "autores": "Juan Montenegro; Carlos Miranda; Gabriela M. Andaluz; Oscar Camacho; Paulo Leica",
    "track": "Robotics and Automation Systems",
    "keywords": [
    ...
    "resumenCorto": "This work presents a neural network-based PID controller for trajectory tracking of a triangular formation of three differential mobile robots. The…",
  ...
  {
    "id": "37",
    "titulo": "Indoor NO2 Exposure Assessment in LPG-Fueled Commercial Kitchens: Occupational Risk Implications in a Peri-Urban District of Lima, Peru",
    "autores": "Carlos Alfredo Ugarte Alván; Kelly Grace Morocho Yauri; Maryorith Cabigail Vasquez Reyes; Joyce Carol Bottger Gamarra; Lorgio Gilberto Valdiviezo Gonzales; Rubén Victor Munive Cerrón",
    ...
    "resumenCorto": "Commercial kitchen workers face prolonged daily exposure to indoor air pollutants generated by liquefied petroleum gas (LPG) combustion, yet occupational…",
  ...
  {
    "id": "51",
    "titulo": "Sports Inclusion for People with Visual Impairments: A Guidance System for Promoting Adapted Soccer",
    "autores": "Juan Diego Gutierrez Enderica; Damian Roc Olivo Barzallo; Juan Marcelo Pérez Pérez; Henry Paul Tigre Avila; Anabel Sabrina Molina Astudillo",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
      "Sports Inclusion",
      "Visual Impairments",
    ...
    "resumenCorto": "This research addresses the need to promote more autonomous and equitable participation by people with visual impairments in adapted soccer, overcoming…",
  ...
  {
    "id": "66",
    "titulo": "Mobile-U Net-based Architectures for Pulmonary Nodule Segmentation and Classification",
    "autores": "Eduardo Benavides; Edwin Valarezo",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "Lung cancer continues to be a leading cause of global cancer-related mortality, needing advanced triage and diagnostic follow-up via computed tomography…",
  ...
  {
    "id": "79",
    "titulo": "7-DOF Kinematic Model of the Upper Limb in Left Hemiparesis, a Kinematic Redundancy Analysis and Swivel Angle Estimation",
    "autores": "Fabricio Tipantocta; Edwin Valarezo; Juan Carlos Cajo",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "This paper presents a 7-degree-of-freedom (DOF) kinematic model of the human upper limb applied to a person with congenital left hemiparesis. The model…",
  ...
  {
    "id": "91",
    "titulo": "Development and Validation of a Low-Cost Embedded System Based on ESP32 and Python for Force-Displacement Testing in Biomechanical and Materials Applications",
    "autores": "Liliana Jorquera; Angel Custodio; Momchil Semerdjiev; Martin Arriagada",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "This paper describes the design, implementation, and experimental validation of a low-cost embedded force-displacement testing system primarily intended…",
  ...
  {
    "id": "116",
    "titulo": "Adaptive IoT-Based UVC Sterilization for Resilient Healthcare Spaces",
    "autores": "Alejandra Marcia Ayala Allende; Edgar Roberto Ramos Silvestre; Eynar Calle Viles; Marcelo Greby Rojas Fernández",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "This paper presents the design and implementation of an IoT-based ultraviolet-C (UVC) disinfection system aimed at improving infection control in…",
  ...
  {
    "id": "129",
    "titulo": "Wavelet Based ERD/ERS Energy Analysis of Interhemispheric Asymmetry in Resting State EEG",
    "autores": "Alberto M. Peralta-Orellana; Freddy L. Bueno-Palomeque",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "This study investigates interhemispheric asymmetry in EEG activity from a healthy subject under resting state conditions by comparing cortical energy and…",
  ...
  {
    "id": "202",
    "titulo": "Deep Learning Architectures for the Histopathological Classification of Colorectal Adenocarcinoma through Adaptive Contrast Enhancement and Monte Carlo Validation",
    "autores": "Erika Severeyn Varela; Alexandra La Cruz; Mónica Huerta; Jesus Velasquez; Erwin Sacoto-Cabrera",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "Colorectal cancer remains a significant global health challenge, requiring precise early detection to improve patient survival rates. This study proposes…",
  ...
  {
    "id": "205",
    "titulo": "Comparative Analysis of Machine Learning Architectures and Convolutional Neural Networks for the Automated Identification of Brain Neoplasms in Structural MRI",
    "autores": "Erika Severeyn Varela; Alexandra La Cruz; Mónica Huerta; Jesus Velasquez; Erwin Sacoto-Cabrera",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "Brain tumor diagnosis via Magnetic Resonance Imaging (MRI) is essential yet challenging due to subjective manual interpretation. This study presents a…",
  ...
  {
    "id": "219",
    "titulo": "Experimental evaluation of sustainable antibacterial hydrogels using quinoa saponins and silver nanoparticles",
    "autores": "Oscar Ivan Analuiza Maiza",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "The development of sustainable antibacterial biomaterials represents a significant challenge in biomedical applications due to the need to simultaneously…",
  ...
  {
    "id": "223",
    "titulo": "Multi-Zone mmWave Radar Array and Random Forest for Non-Contact Clinical Respiratory Monitoring",
    "autores": "Dayanna Pazmiño-Yauli; Freddy Ajila-Zaquinaula; Henry Mayorga Pérez; Alberto Guapi; France Andreina Maldonado González; César Palacios-Arias",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "Continuous respiratory monitoring is a cornerstone of critical care, yet conventional contact-based sensors (e.g., chest belts, cannulas) often cause skin…",
  ...
  {
    "id": "229",
    "titulo": "Simulation and Analysis of Molecular Communications Systems for Tumor Cells Detection",
    "autores": "Yesenia Cevallos; Elvis Pilligua; Luis Tello-Oquendo; Jesus B. Alonso; Paola Vinueza-Naranjo; Albert Espinal; Deysi Inca; Alejandra Pozo; Daniel Haro-Mendoza",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "Molecular Communications (MCs) are the essential mechanisms that living beings use to transmit information regarding vital functions for survival or even…",
  ...
  {
    "id": "259",
    "titulo": "Evaluating VTOL UAVs and Resilient Navigation Models for Medical Logistics in the Ecuadorian Amazon",
    "autores": "Marlon Estuardo Guadalupe Intriago; Guillermo Armando Veliz-Velez; Jonathan Paul Zambrano Arriaga; Anibal Isaac Pruna Santillán; Ginger Yuleixy Rivera Ayón",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "Medical logistics in the Ecuadorian Amazon are severely hindered by an inefficient bimodal (land-fluvial) infras- tructure, directly compromising the…",
  ...
  {
    "id": "277",
    "titulo": "Low-Cost Instrumentation for Knee Strength Assessment: Hardware Design, Calibration, and Validation of a System Based on Load Cells and ESP32",
    "autores": "Liliana Jorquera; Angel Custodio",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "This paper presents the design, implementation, and experimental validation of a low-cost instrumentation system for measuring knee muscle force, with an…",
  ...
  {
    "id": "294",
    "titulo": "IoT-Based Wearable System for Real-Time Dorsolumbar Posture Monitoring with Vibrotactile Biofeedback Capability",
    "autores": "Felipe Matovelle-Romero; Gustavo Lozada-Castro; Francisco Alvarado-Salinas; Gabriela Aguirre-Vicuña; Diego Almeida-Galárraga",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "Musculoskeletal disorders (MSDs), particularly chronic lower back pain (LBP), are highly prevalent among sedentary office workers due to prolonged static…",
  ...
  {
    "id": "300",
    "titulo": "Multimodal Active Glove Prototype for Rehabilitation: A Preliminary Study",
    "autores": "Andrea Rojas-Buñay; Tamara Suarez-Minchala; Ana Cecilia Villa-Parra",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "Functional alterations of the hand caused by neurological and musculoskeletal disorders can significantly limit the performance of activities of daily…",
  ...
  {
    "id": "308",
    "titulo": "Design and Validation of an IoT Wearable System for Tremor Quantification in Patients with Parkinson's Disease",
    "autores": "Jessica Balseca; Monica Huerta; Erwin Sacoto-Cabrera; Esteban-Fernando Ordoñez-Morales; Roger Clotet",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
      "Parkinson's Disease",
    ...
    "resumenCorto": "Parkinson's disease is characterized by motor impairments, including resting tremor, whose clinical assessment often relies on sporadic and subjective…",
  ...
  {
    "id": "315",
    "titulo": "Acquisition of muscle signals based on Optomyography for hand gesture classification using infrared sensors and Machine Learning",
    "autores": "Joel Flores-Delgado; David Zurita; Alan Tierra-Llanga; Jorge Paredes; Alexandra Pazmiño-Armijos; Ramiro Isa-Jara",
    "track": "Engineering in Medicine and Biology",
    "keywords": [
    ...
    "resumenCorto": "This research presents the development of a signal acquisition system using near-infrared (NIR) sensors for the detection and classification of hand…",
  ...
  {
    "id": "32",
    "titulo": "Automated Appointment Notification Module for Intelligent Healthcare Resource Optimization",
    ...
    "resumenCorto": "This paper presents the design and prototype-level assessment of an automated notification module for medical appointment management in an anonymized…",
  ...
  {
    "id": "65",
    "titulo": "Operational Viability of Random Forest Classifiers for DDoS Detection on Commodity Hardware",
    "autores": "Darwin Pillo; Galo Puetate; Diego Pabon",
    "track": "Computer and Software Engineering",
    "keywords": [
    ...
    "resumenCorto": "Distributed Denial-of-Service attacks, particularly TCP SYN Floods, threaten institutional WiFi network availability. Traditional intrusion detection…",
  ...
  {
    "id": "99",
    "titulo": "Methodological Framework for Fine-Tuning LLMs in Secure Code Generation: An Integrated Barrier Mitigation Approach",
    "autores": "Samuel Lascano; Anderson Granizo; Nadia N. Sánchez-Pozo",
    "track": "Computer and Software Engineering",
    "keywords": [
    ...
    "resumenCorto": "Fine-tuning large language models (LLMs) for secure code generation has become a transformative paradigm in software engineering. However, its effective…",
  ...
  {
    "id": "112",
    "titulo": "Data Preparation Matters: A Reproducible and Fairness-Aware Pipeline for Academic Recommender Systems",
    "autores": "Marco Aguirre; Carlos Ayala-Tipan; Angel Chuncho; Lorena Recalde; Diana Martinez-Mosquera; Gabriela Suntaxi",
    "track": "Computer and Software Engineering",
    "keywords": [
    ...
    "resumenCorto": "Large-scale bibliometric datasets are core infrastructure for scientometric analysis, research evaluation, and academic recommender systems. While major…",
  ...
  {
    "id": "140",
    "titulo": "TOGAF-Based Enterprise Architecture with N8n Workflow Automation for CRM Process Optimization in Ecuadorian Educational Institutions",
    "autores": "Esau Hernan Moreno Murillo; Noel Batista Hernández; Maikel Yalandi Leyva Vázquez",
    "track": "Computer and Software Engineering",
    "keywords": [
    ...
    "resumenCorto": "Educational institutions in emerging economies manage CRM processes through fragmented manual workflows that generate enrollment bottlenecks…",
  ...
  {
    "id": "152",
    "titulo": "Operative Prompt Chains as Engineering Artifacts: A Quality Rubric for AI-Assisted Software Development with Governed Agent Autonomy and Run ID Audit Traceability",
    "autores": "Manuel-Enrique Puebla-Martínez; Maikel Yelandi Leyva Vazquez; Florentin Smarandache",
    "track": "Computer and Software Engineering",
    "keywords": [
    ...
    "resumenCorto": "Current practice in AI-assisted software engineering treats operative prompts as ephemeral conversational text rather than technical artifacts with…",
  ...
  {
    "id": "162",
    "titulo": "Embedded Document Reader for Visually Impaired Users Using Gemini 2.5 Flash: ROUGE and TAM Evaluation",
    "autores": "Oscar M. Cumbicus-Pineda; Hernan Leonardo Torres Carrión; Pablo Fernando Ordoñez Ordoñez; Francisco Álvarez Pineda; Juan Pablo Torres Calva; Luis Daniel Cobos Arevalo; David Alejandro Rodriguez Celi",
    "track": "Computer and Software Engineering",
    "keywords": [
      "Gemini 2.5 Flash",
    ...
    "resumenCorto": "Visual impairment affects an estimated 2.2 billion people globally, with 58,388 persons with visual disability registered in Ecuador as of November 2025…",
  ...
  {
    "id": "291",
    "titulo": "Comparative Analysis of LSB and Patchwork Steganographic Techniques: A Statistical Evaluation of Visual Imperceptibility",
    "autores": "Maicol Brayan Llivisaca; Víctor José Huilca; Alexandra Macarena Flores",
    "track": "Computer and Software Engineering",
    "keywords": [
    ...
    "resumenCorto": "Digital steganography plays a critical role in information security by concealing the existence of hidden messages within carrier files. Among available…",
  ...
  {
    "id": "41",
    "titulo": "Ecuador's Cybersecurity Commitment-Capability Gap: A Multi-Index Assessment",
    "autores": "Luis Alberto Herrera Lara; Roberto Carlos Herrera Lara",
    ...
    "resumenCorto": "This paper assesses Ecuador's national cybersecurity posture through a mixed-methods framework combining quantitative index benchmarking with qualitative…",
  ...
  {
    "id": "46",
    "titulo": "Semantic Image Transmission for Industrial Visible Light Communications",
    "autores": "Alejandro Arratia Pavat; Pablo Palacios; María Camila Reyes; Cesar Azurdia Meza; Alberto Castro; David Zabala-Blanco; Ismael Soto; Iván Sánchez; Milton Román",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "Visible light communication (VLC) is a promising option for indoor industrial wireless links, yet image transmission remains costly in the presence of…",
  ...
  {
    "id": "55",
    "titulo": "Artificial Intelligence in Visible Light Communication (VLC) State of the Art",
    "autores": "Angel Guevara; José Luis Lázaro-Galilea; Álvaro De la Llana Calvo; Héctor Chinchero; Juan Landazuri",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "This work presents a review of the state of the art of Visible Light Communication (VLC) systems, focusing on Artificial Intelligence (AI) as the key…",
  ...
  {
    "id": "56",
    "titulo": "IoT Angle Measurement System for a Microwave Breast Imaging Device Employing Kalman Filter and Rodrigues’ Rotation Formula",
    "autores": "Rodrigo Patta; Álec Yoshida; Leandro Amorim; Alexandre de Jesus Aragão",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "This work presents the assessment of an Internet of Things embedded sensor tile programmed for the measurement of the rotation angle of a handheld device…",
  ...
  {
    "id": "68",
    "titulo": "Domain-Adaptive Preprocessing and Temporal Attention for Cybersecurity Anomaly Detection in Legacy Industrial Control Systems",
    "autores": "Roberto Carlos Herrera Lara; Mario Aragones Lozano",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "Most deep learning models for anomaly detection in Industrial Control Systems (ICS) are trained and evaluated on a single benchmark. When such a model…",
  ...
  {
    "id": "161",
    "titulo": "Cybersecurity Resilience for Cooperative Financial Institutions: A Humanitarian Approach to Protecting Vulnerable Communities’ Financial Services in Ecuador",
    "autores": "Janner Alcivar; Juan Jose Calle de la A; Dayron Rumbaut Rangel; Maykel Leyva Vazquez",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "Cooperative financial institutions serve as critical financial lifelines for underserved communities in Latin America. In Ecuador, cybersecurity incidents…",
  ...
  {
    "id": "168",
    "titulo": "Self-Supervised Near-Optimal Combining Weights for Indoor Multi-Cell VLC With Angle-Diversity Receivers",
    "autores": "Jairo Morales Huaman; Pablo Palacios; María Camila Reyes; Cesar Azurdia Meza; Alberto Castro; David Zabala-Blanco; Iván Sánchez; Milton Román",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "Conventional maximal-ratio combining (MRC) in angle-diversity receivers (ADRs) assigns branch weights from the per-photodiode…",
  ...
  {
    "id": "169",
    "titulo": "Toward ITU-T Y.1541-Oriented Latency Control for Videoconferencing over Shared Cellular Tethering: A Low-Cost QoS Gateway Pilot in Ecuador",
    "autores": "Eduardo Alvarado",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "Cellular tethering is widely used in Ecuadorian households when fixed broadband is unavailable, unreliable, or unaffordable. However, tethered links may…",
  ...
  {
    "id": "172",
    "titulo": "LoRaWAN-Based IoT Architecture for Real-Time Monitoring of Agro-Environmental Variables in Coffee Farming Systems",
    "autores": "Franklin Jiménez; Marianela Carrión; Jordy Cabrera",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "This study presents the design, development, and implementation of a prototype wireless sensor network aimed at monitoring agro-environmental variables in…",
  ...
  {
    "id": "189",
    "titulo": "Energy Decomposition of a LoRaWAN Class A Node: From Time-on-Air Modeling to Hardware Efficiency Constraints",
    "autores": "Giovanny Cuzco",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "The energy consumption of LoRaWAN Class A nodes depends on both link-layer configuration and the quiescent characteristics of the underlying hardware…",
  ...
  {
    "id": "193",
    "titulo": "A Virtual Instrumentation Framework for Low-Cost Metrological Evaluation of Protected Management Frames in Dense Wireless Networks.",
    "autores": "David Cardenas Villacres",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "This paper presents the design and implementation of a virtual instrumentation framework tailored for the empirical diagnostic audit and metrological…",
  ...
  {
    "id": "195",
    "titulo": "IoT ULEAM: A Platform for Multidisciplinary Topics",
    "autores": "Willian Zamora; Carlos T Calafate; Mike Machuca; Robert Moreira Centeno; Edison Almeida; Oscar Gonzalez",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "his paper presents IoT ULEAM, a web-based Internet of Things platform developed at Universidad Laica Eloy Alfaro de Manabí (ULEAM) to support…",
  ...
  {
    "id": "211",
    "titulo": "Interpretable Transmission Quality Classification in PON Access Networks Using Random Forest",
    "autores": "Berenice Arguero; Christian Tipantuña; Germán V. Arévalo; Danilo Sigcha",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
      "PON Access Networks",
      "Random Forest",
    ...
    "resumenCorto": "Monitoring transmission quality in passive optical access networks is a relevant challenge due to the variation of the physical link conditions and the…",
  ...
  {
    "id": "213",
    "titulo": "Technical, Economic, and Social Impact of FM Band Reorganization in Colombia",
    "autores": "Hernan Paz Penagos; Nibia A. Morales-Chiw; Jose D. Velasco-Melo",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "Colombia's 88–108 MHz frequency-modulation (FM) band is close to saturation, limiting new assignments, analog-to-digital migration and quality…",
  ...
  {
    "id": "220",
    "titulo": "Experimental Analysis of Crosstalk Between two LTE Carriers in a Hybrid RoF-PON Architecture",
    "autores": "Adriana Riofrio; Berenice Arguero",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "This paper analyzes the impact of crosstalk in a hybrid radio-over-fiber (RoF) architecture for the transmission of two adjacent LTE signals at 380 MHz…",
  ...
  {
    "id": "276",
    "titulo": "On the Impact of Oracle Imperfections in Cryptographic Algorithms",
    "autores": "Michael Paucar",
    "track": "Communications, IoT & Cybersecurity",
    "keywords": [
    ...
    "resumenCorto": "Cryptographic security proofs often rely on idealized oracle models, yet practical implementations introduce approximation, numerical error, and other…",
  ...
  {
    "id": "10",
    "titulo": "Evidence-Driven Co-Design of Diagnosis and Recovery for Offshore Wind Turbines",
    "autores": "Yat Ping Lam; Silvio Simani",
    ...
    "resumenCorto": "Offshore wind turbines must preserve energy production, structural integrity, and availability under fluctuating winds, waves, and component degradations…",
  ...
  {
    "id": "17",
    "titulo": "Comparative Analysis of PID-Based Controllers for Seismic Active Structural Control",
    "autores": "Luis Caiza; Pablo Torres-Rodas; Diego S. Benitez; Fabricio Yepez; Noel Pérez-Pérez; Oscar Camacho",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "This paper presents a comparative study of linear, nonlinear, and fractional-order PID controllers for reducing seismic response in buildings. The…",
  ...
  {
    "id": "40",
    "titulo": "A Proportional-Integral Retarded Reaching Law for Sliding Mode Control of Time-Delay Processes",
    "autores": "Oscar Camacho; Sebastian Vega; Florindo A. de C. Ayres Jr; Juan J. Gude; Fernando Auat-Chein; Antonio Di Teodoro",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "This work proposes a proportional–retarded PID (PIR) formulation for the reaching phase of sliding mode control (SMC) in nonlinear time-delay systems. The…",
  ...
  {
    "id": "75",
    "titulo": "Real-Time Modeling of Synchronous Reluctance Machines for Hardware-in-the-Loop Simulation: A State-of-the-Art Review",
    "autores": "Joaquín Córdova; Johnny Rengifo",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "Synchronous reluctance machines (SynRMs) are increasingly adopted in high-efficiency variable-speed drives, yet their pronounced magnetic nonlinearities…",
  ...
  {
    "id": "81",
    "titulo": "Performance Comparison of PI and Deep Reinforcement Learning Controllers for PMSM Current Control in a Real-Time Simulation Environment",
    "autores": "Luis Muñoz; Patricia Pasmay; Síxifo Falcones",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "This paper presents a comparative evaluation of a classical proportional integral (PI) controller and four deep reinforcement learning (DRL) controllers…",
  ...
  {
    "id": "85",
    "titulo": "Performance Trade-Offs in Nonlinear Fractional-Order PID Controllers.",
    "autores": "Antonio Di Teodoro; Juan J. Gude; Hanna Aboukheir; Oscar Camacho",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "This paper presents a comparative analysis of nonlinear fractional-order PID (FOPID) controllers under disturbance rejection, reference tracking, and…",
  ...
  {
    "id": "170",
    "titulo": "An Active Fault-Diagnosis Framework for the 8/6 Switched Reluctance Motor: Idle-Phase Probing, Bayesian Belief, and Safety Constraints",
    "autores": "Franklin Sánchez; Maria Milanes; Enrique Romero; Jose Manuel Aller Castro",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "Inter-turn short circuits in switched reluctance mo- tor (SRM) windings are difficult to detect at an incipient stage because the circulating current in…",
  ...
  {
    "id": "183",
    "titulo": "Data-Driven Predictive Control with Extended State Kalman Estimation for Nonlinear Systems",
    "autores": "Hanna Aboukheir; Pedro Teppa",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "This paper presents a data-driven predictive control strategy for nonlinear systems with unknown dynamics. The proposed approach combines an Extended…",
  ...
  {
    "id": "196",
    "titulo": "Comparative Evaluation of Controllers and Bio-Inspired Optimization Algorithms for Ball-and-Beam Systems",
    "autores": "Juan Valencia Castañeda; Andrea Pilco; Oswaldo Menéndez; Robert Guamán Rivera; Juan Pablo Vásconez",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "The Ball-and-Beam (BnB) system is a classical benchmark in control engineering due to its nonlinear, underactuated, and inherently unstable dynamics. This…",
  ...
  {
    "id": "204",
    "titulo": "Training-Data Coverage Governs Open-Phase Fault Response in Offline Reinforcement Learning for Induction Motor Drives",
    "autores": "Franklin Sánchez; María Isabel Milanés Montero; Enrique Romero Cadaval",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "Fault-tolerant control of induction motor drives is usually built on an explicit fault detector coupled to a hand- designed reconfiguration law. This…",
  ...
  {
    "id": "207",
    "titulo": "A Deep Learning-Based Soft-Sensor for Real-Time Angular Velocity Estimation in Three-Phase Induction Motors Under Dynamic Load Scenarios",
    "autores": "Fernando Quinapanta; Lady Panchi",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "Accurate real-time estimation of angular velocity (RPM) is fundamental for condition monitoring, fault diagnosis, and closed-loop control of three-phase…",
  ...
  {
    "id": "218",
    "titulo": "Data-Driven Setpoint Correction for a Buck Converter Under a Voltage-Sensor Fault that Integral Action Cannot Reject",
    "autores": "Franklin Sánchez; Mark Lopez",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
      "Buck Converter",
    ...
    "resumenCorto": "An affine voltage-sensor fault, in which the mea- sured output equals a gain times the true output plus a bias, causes any controller that regulates the…",
  ...
  {
    "id": "230",
    "titulo": "Analysis of Inter-Turn Faults in Three-Phase Induction Motors Under FCS-MPC Predictive Control With and Without Fault-Tolerant Strategies",
    "autores": "Victor Vargas; Sheila Milena Salinas Castillo; Franklin Sánchez",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
      "Inter-Turn Faults",
      "Three-Phase Induction Motors",
    ...
    "resumenCorto": "Three-phase induction motors are widely used in industrial applications due to their robustness and high reliability. However, inter-turn faults in stator…",
  ...
  {
    "id": "233",
    "titulo": "Scenario-aware fault diagnosis of an induction motor using reduced current measurements and machine learning.",
    "autores": "Iván León; Franklin Sánchez; Edgar Pallo",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "This paper presents a scenario-aware validation framework for electrical fault diagnosis in a squirrel-cage induction motor using reduced current…",
  ...
  {
    "id": "269",
    "titulo": "Fractional-Order Control Optimization for Differential Mobile Robots Using Improved PSO",
    "autores": "Edwin Palacios; Luis Herrera Baños; Efrén Herrera Baños; Karla Jacome; Pablo Palacios; Efrén Herrera Muentes",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "This paper investigates the trajectory-tracking problem of differential drive mobile robots using a fractional-order PID (FOPID) controller tuned through…",
  ...
  {
    "id": "288",
    "titulo": "Hardware Modernization and Digital Control of a Coupled pH–Temperature Process Using Stoichiometric Feedforward: Experimental Validation on a Didactic Plant",
    "autores": "Dennys Cortez; Carlos Salazar; Joaquín Rendón; Erik Moncayo; Adriana Aguirre; Andrés Salazar",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "This paper presents the design, implementation, and experimental validation of a digital control strategy applied to a coupled pH–temperature process…",
  ...
  {
    "id": "289",
    "titulo": "Robust PID Control and Cyber-Physical SCADA Supervision for Steam Turbine Seal Pressure Regulation Based on Industrial Data",
    "autores": "Carlos Salazar; Denisse Fiallos; Adriana Aguirre; Andrés Salazar",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "Proper seal steam pressure regulation is required to maintain the thermodynamic performance and operational reliability of industrial steam turbines, as…",
  ...
  {
    "id": "292",
    "titulo": "Gain-Scheduled PID Control of a 1DoF Helicopter via Quasi-LPV Modeling",
    "autores": "Galo Guzmán; Henry Maldonado; Ismael Minchala",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "Gain-scheduled control of nonlinear systems is commonly limited by the proliferation of scheduling parameters that arise when multiple structural…",
  ...
  {
    "id": "295",
    "titulo": "Multivariable control of a temperature system using decoupling, PIR and FOPID controllers",
    "autores": "José Castillo; Nathaly Guijarro; Oscar Camacho",
    "track": "Industrial Electronics, Systems Control & Signal Processing",
    "keywords": [
    ...
    "resumenCorto": "This paper presents the analysis, design, and comparison of multivariable control strategies applied to the TCLab device in its TITO configuration. First…",
  ...
  {
    "id": "29",
    "titulo": "A Workflow-Based Architecture for Academic Process Automation Through REST API Integration: Empirical Evaluation in a Public Higher Education Institution",
    "autores": "Susana Patiño; Junior Rojas Rosado; Javier Quiñónez Quiñónez; Néstor Quiñónez",
    ...
    "resumenCorto": "This paper presents the design, implementation, and empirical evaluation of a workflow-based architecture for automating academic enrollment and…",
  ...
  {
    "id": "30",
    "titulo": "Integrated Lean Six Sigma Planning Model for Perfect Order Reliability in UPS Electrical Installation Projects: Emerging-Market Evidence",
    "autores": "Fernando Maradiegue",
    "track": "Technology and Engineering Management",
    "keywords": [
    ...
    "resumenCorto": "One of the main dependability issues in emerging-market infrastructure is schedule non-compliance in UPS electrical installation projects. The company…",
  ...
  {
    "id": "44",
    "titulo": "Integrated Management System Design for ISO 9001 and ISO 45001 Integration in a Private Security Company",
    "autores": "Marcela Coronel; Jorge Chávez",
    "track": "Technology and Engineering Management",
    "keywords": [
    ...
    "resumenCorto": "Private security firms increasingly depend on standardized quality and occupational health and safety systems, yet parallel implementation can weaken…",
  ...
  {
    "id": "89",
    "titulo": "Evaluation of a Business Intelligence Framework for Academic Decision-Making at the University of Guayaquil",
    "autores": "Jorge Misael Merchán Riera",
    "track": "Technology and Engineering Management",
    "keywords": [
    ...
    "resumenCorto": "Digital transformation in higher education institutions has significantly increased the generation of academic and administrative data, creating the need…",
  ...
  {
    "id": "234",
    "titulo": "A DATA PRIVACY COMPLIANCE MANAGEMENT MODEL FOR PUBLIC INSTITUTIONS: AN ICN-BASED FRAMEWORK ALIGNED WITH ECUADOR’S LOPDP",
    "autores": "Carlos Caraguay",
    "track": "Technology and Engineering Management",
    "keywords": [
    ...
    "resumenCorto": "Ecuador’s Organic Law on Personal Data Protection (LOPDP, 2021) establishes legally binding obligations for public institutions, yet compliance remains…",
  ...
  {
    "id": "266",
    "titulo": "Do specialized chatbots outperform free AI tools? A comparative study among higher education students",
    "autores": "Sandra Nadyedja Landázuri Espinoza",
    "track": "Technology and Engineering Management",
    "keywords": [
      "Chatbot",
      "Course",
    ...
    "resumenCorto": "Abstract— This study compares the perceived learning outcomes between university students using an institutional chatbot specific to their discipline and…",
  ...
  {
    "id": "31",
    "titulo": "Multi-Pulse Drive Migration for Harmonic Mitigation in ESP Systems",
    "autores": "Jonathan Michael Gonzalez Espinosa",
    ...
    "resumenCorto": "This paper evaluates harmonic mitigation in electric submersible pump (ESP) systems using field data from 43 variable-speed drives (VSDs) installed in an…",
  ...
  {
    "id": "47",
    "titulo": "An Improvement Model Based on Poka-Yoke 4.0 and TPM 4.0 for Defect Reduction in Injection Molding within the Pharmaceutical Industry",
    "autores": "Melanie Hospina; Genesis Caqui; Gabriela Cauvi",
    "track": "Industry Applications and Reliability",
    "keywords": [
    ...
    "resumenCorto": "This study proposes an improvement model aimed at reducing the high rate of defective products in the injection molding process of bottles in a…",
  ...
  {
    "id": "48",
    "titulo": "TPM-SMED-Standardized Work Model with IoT- Based Predictive Maintenance and Industry 4.0 for Optimizing Operational Efficiency in Bronze Bushing Machining in a Metalworking SME",
    "autores": "Reich Sanchez; Luciana Montes; Gabriela Cauvi",
    "track": "Industry Applications and Reliability",
    "keywords": [
    ...
    "resumenCorto": "Low operational efficiency (77.94%) in the bronze bushing machining process at a metalworking SME in Lima, Peru, generated a technical gap of 7.25…",
  ...
  {
    "id": "49",
    "titulo": "Improvement proposal using TPM, 5S and Poka-Yoke with Industry 4.0 support for order fulfillment in a wood pallet SME",
    "autores": "Fernando Maradiegue",
    "track": "Industry Applications and Reliability",
    "keywords": [
    ...
    "resumenCorto": "Abstract—This paper presents MILP-Pallet (Integrated Model Lean-Pallet), a Lean-Industry 4.0 methodology, which automates Predictive Analytic Insights…",
  ...
  {
    "id": "50",
    "titulo": "Lean Green Model and Industry 4.0 for Defect Reduction and Waste Valorization in Plywood Manufacturing",
    "autores": "Fernando Maradiegue",
    "track": "Industry Applications and Reliability",
    "keywords": [
    ...
    "resumenCorto": "Plywood manufacturing in emerging markets faces critical quality and sustainability challenges: up to 55% of processed volume is discarded and defect…",
  ...
  {
    "id": "54",
    "titulo": "Integrated Production Planning and Inventory Control Model with Machine Learning and Slotting to Improve Fill Rate in Artisanal Beverage MSMEs",
    "autores": "Fernando Maradiegue",
    "track": "Industry Applications and Reliability",
    "keywords": [
    ...
    "resumenCorto": "Abstract–Peruvian artisanal beverage MSMEs suffer from repeated failures to fulfill orders. The Fill Rate for the organization in the study was 72.43%…",
  ...
  {
    "id": "63",
    "titulo": "Improvement model for On- Time Delivery (OTD) in suspension manufacturing: based on TPM Planned Maintenance - IoT in Machine Learning",
    "autores": "Carlos Maceda; Daniela Cristobal; Carlos Baca",
    "track": "Industry Applications and Reliability",
    "keywords": [
    ...
    "resumenCorto": "The objective of this study is to improve On -Time Delivery (OTD) in the manufacturing of semi-trailer parts at a metalworking company, where delivery…",
  ...
  {
    "id": "148",
    "titulo": "Integrated model based on Standard Work, Autonomous Maintenance, Planned Maintenance and IoT to improve the overall efficiency of equipment in a company in the plastics sector",
    "autores": "Jorge Estelo-Marcos; Cristhian Lopez-Guzman; Iliana Macassi; Jose C. Alvarez Merino; Orkun Yildiz",
    "track": "Industry Applications and Reliability",
    "keywords": [
      "plastics sector",
      "Planned Maintenance",
    ...
    "resumenCorto": "In recent years, the plastics industry has faced a decline in overall equipment efficiency due to machinery shutdowns and rework. The objective of this…",
  ...
  {
    "id": "245",
    "titulo": "Methodological Proposal for Interpreting Dielectric Oil Test Results in Power Transformers",
    "autores": "Alexander Cespedes; Jimmy Vásquez; Karent Martínez",
    "track": "Industry Applications and Reliability",
    "keywords": [
    ...
    "resumenCorto": "This work presents a methodological guide for analyzing and interpreting physicochemical tests of dielectric oil to improve consistency between laboratory…",
  ...
  {
    "id": "263",
    "titulo": "Migration of MOVIMOT Decentralized Drives to a Centralized Architecture with Danfoss VLT FC 280 Variable Frequency Drives via PROFIBUS-DP",
    "autores": "Efrén Herrera Muentes; Erick Briones Chasi; Jhon Larreategui Ulloa; Efrén Herrera Baños; Luis Herrera Baños; Holger Cevallos Ulloa",
    "track": "Industry Applications and Reliability",
    "keywords": [
    ...
    "resumenCorto": "This paper presents a reliability-oriented migration of an industrial palletizing system from six MOVIMOT decentralized integrated motor drives to a…",
  ...
  {
    "id": "320",
    "titulo": "Development of a Drone-Based Image Acquisition System with Machine Learning for Binary Classification of Pitahaya Vegetation",
    "autores": "Paúl Quinchuela",
    "track": "Industry Applications and Reliability",
    "keywords": [
    ...
    "resumenCorto": "Precision agriculture has emerged as a fundamental approach for optimizing crop management, particularly in regions where high-value tropical fruits…",
